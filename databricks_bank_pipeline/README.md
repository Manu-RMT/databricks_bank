# databricks_bank_pipelines

This folder defines all source code for the 'databricks_bank_pipelines' pipeline:
...
* Take a look at the sample under "sample_users_databricks_bank_pipelines.py" to get familiar with the syntax.
